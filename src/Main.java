...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hotel hotel = new Hotel(Zone.SEA, "Casa Maria", "Gorj", "Targu Jiu", "Ecaterina Teodoroiu", "2A", 4, Boolean.TRUE, Boolean.TRUE, 45f, 20);
        Concert concert = new Concert(hotel, "100DAY", 500, LocalDate.of(2021,1,23),LocalDate.of(2021,2,23), new Hour(10,10), new Hour(11,20), 5, "Popescu Mihalea", 4000f);
        service.locations.add(hotel);
        service.events.add(concert);

        GuestHouse guestHouse = new GuestHouse(Zone.MOUNTAIN, "Casa Mihai", "Arges", "Pitesti", "Tudor Vladimirescu", "41C", 3, Boolean.TRUE, 0f, Boolean.TRUE, 123f, Boolean.FALSE);
        SchoolCamp schoolCamp = new SchoolCamp(guestHouse, "Tabara copiilor", 23,  LocalDate.of(2021,1,23),LocalDate.of(2021,2,23), new Hour(12,11), new Hour(15,8),4,2,2,2 );
        service.locations.add(guestHouse);
        service.events.add(schoolCamp);
