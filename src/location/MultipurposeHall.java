...
public class MultipurposeHall extends Location{
    ...
    public void Read_Info() {
        System.out.print("------------Multipurpose Hall---------\n");
    ...
    public float price_location() {
        ...
        price_location = price_location + number_of_seats * price_per_seats;
        if (audio_equipment)
            price_location = price_location + price_of_the_audio_equipment;
        if (video_equipment)
