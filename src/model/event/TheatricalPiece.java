...
public class TheatricalPiece extends Event{
    ...
    public TheatricalPiece(Location location, String name_event, Integer number_of_tickets, LocalDate date_start, LocalDate date_end, event.Hour hour_start, event.Hour hour_end, Integer number_of_pause, String theme, String name_of_team, Float price_of_team, Type_ticket type_ticket) {
